...
A tool for generating QR codes from various data types including text, URLs, WiFi credentials, and vCards. Supports customization and download in multiple formats.
...
1. As a user, I want to generate QR codes for URLs to share links easily
2. As a user, I want to create WiFi QR codes for easy network sharing
3. As a user, I want to generate vCard QR codes for contact sharing
4. As a user, I want to customize QR code colors and size
...
|---------|-------------|----------|
| Text/URL QR | Generate QR from text/URL | P0 |
| WiFi QR | Generate WiFi connection QR | P0 |
| vCard QR | Generate contact QR | P1 |
| Size Options | Various pixel sizes | P0 |
| Color Customization | Foreground/background | P1 |
| Download PNG | Download as image | P0 |
| Download SVG | Download as SVG | P1 |

### Data Types

| Type | Format | Use Case |
|------|--------|----------|
| Text | Plain text | General purpose |
| URL | HTTP/HTTPS link | Website sharing |
| Email | mailto: link | Email sharing |
| Phone | tel: link | Phone number |
| WiFi | WIFI:T:WPA;S:...;P:...;; | Network credentials |
| vCard | Contact format | Business cards |
...
- [ ] Text QR generates correctly
- [ ] URL QR generates correctly
- [ ] WiFi QR generates correctly
- [ ] vCard QR generates correctly
- [ ] Email QR generates correctly
- [ ] Phone QR generates correctly
- [ ] Size adjustment works
- [ ] Color customization works
- [ ] Error correction options work
- [ ] PNG download works
- [ ] SVG download works
...
**4-5 hours** - Library handles QR generation, UI for multiple types.

## Notes

- `qrcode` library is well-maintained and supports browser usage
- WiFi format: `WIFI:T:<security>;S:<ssid>;P:<password>;H:<hidden>;;`
- vCard format follows standard RFC 2426
- Error correction higher levels allow more damage tolerance
- Consider adding logo overlay option in future
