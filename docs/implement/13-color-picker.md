...
A tool for picking colors, converting between color formats (HEX, RGB, HSL, CMYK), and checking WCAG color contrast for accessibility.
...
1. As a developer, I want to convert colors between different formats
2. As a designer, I want to pick colors using a visual picker
3. As a developer, I want to check color contrast for accessibility
...
|---------|-------------|----------|
| Color Picker | Native HTML color input | P0 |
| Format Conversion | HEX, RGB, HSL, CMYK | P0 |
| Copy Each Format | Copy individual format | P0 |
| Contrast Checker | WCAG contrast ratio | P1 |
| Color Preview | Large preview swatch | P1 |
| Palette Suggestion | Suggest complementary colors | P2 |
...
| HEX (Short) | #F53 | CSS shorthand |
| RGB | rgb(255, 87, 51) | CSS, JavaScript |
| RGBA | rgba(255, 87, 51, 0.5) | CSS with transparency |
| HSL | hsl(11, 100%, 60%) | CSS |
...
- [ ] HSL conversion correct
- [ ] CMYK conversion correct
- [ ] Alpha slider works
- [ ] Copy each format works
- [ ] Contrast ratio calculation correct
- [ ] WCAG AA/AAA checks work
- [ ] Random color works
- [ ] Dark mode styling
- [ ] Mobile responsive
...
**3-4 hours** - All native browser APIs, straightforward math.

## Notes

- Uses native `<input type="color">` for color selection
- Contrast calculation follows WCAG 2.0 guidelines
- Could add color palette generation (complementary, analogous, triadic)
- Could add color blindness simulation
